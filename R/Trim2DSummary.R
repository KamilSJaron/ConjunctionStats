...
#'
#' @description
#' \code{Trim2DSummary} integrates the the output of \code{ReadSummary} and \code{ReadSetting} functions into a list of data.frame objects. Warning: choose this function if Conjunction simulation was run in a 2D world; choose alternative function \code{TrimSummary} instead if Conjunction simulation was run in a 1D world.
#'
...
#'    myTrim2DSummary = Trim2DSummary(sim=mySim, centers=myCenters)
#' }
#'
#' @export
